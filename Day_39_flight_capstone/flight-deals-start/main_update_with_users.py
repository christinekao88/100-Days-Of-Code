...
for destination_code in destinations:
    ...
    ################
    # if the flight data is empty, you'll return an empty flight object (None) to main.py 
    # you can use continue to let the for loop to continue to run when flight is None.
    if flight is None:
        continue
    ################
